...
public class IntersectInfo {
    ...
    private Vector3D position; // position of intersection
    private Vector3D normal; // normal vector on intersection point 
    ...
    public void setNormal(final Vector3D norm) {
        this.normal = norm;
    }
